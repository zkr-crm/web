...
//  server.middleware = proxyMiddleware('/mobile', {target: 'http://api04.aliyun.venuscn.com', changeOrigin: true});
    ...
    proxyMiddleware('/crm/ecif', {target: 'http://10.16.8.142:8088/crm-ecif', changeOrigin: true}),
    proxyMiddleware('/crm/scheduler', {target: 'http://10.16.8.142:8088/crm-scheduler', changeOrigin: true}),
    proxyMiddleware('/crm/query', {target: 'http://10.16.8.142:8088/crm-query', changeOrigin: true}),
    proxyMiddleware('/crm/manage', {target: 'http://10.16.8.142:8088/crm-manage', changeOrigin: true}),
    proxyMiddleware('/crm/ocrm', {target: 'http://10.16.8.142:8088/crm-ocrm', changeOrigin: true}),
    proxyMiddleware('/crm/supply', {target: 'http://10.16.8.142:8088/crm-supply', changeOrigin: true})
    ];

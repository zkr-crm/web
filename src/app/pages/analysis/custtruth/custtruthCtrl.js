(function() {
	...
	angular.module('BlurAdmin.pages.analysis.custtruth').controller('custtruthCtrl', custtruthCtrl);
	/** @ngInject */
	function custtruthCtrl($scope, $uibModal, $filter, $timeout, $http,HttpService, EnumType, $rootScope, Alert) {

(function () {
    ...
    angular.module('BlurAdmin.pages.profile')
        .controller('selectMsgConfCtrl', selectMsgConfCtrl);

    /** @ngInject */
    function selectMsgConfCtrl($scope, $http, HttpService,$uibModalInstance, EnumType, Alert) {
        // 用户对象
        $scope.msgTpl = {};
        // 查询条件对象
        $scope.searchObj = {};
        ...
        // 业务类型显示
        $scope.showBusiTypes = function(item) {

(function () {
    ...
    function tagMgrCtrl($scope, $uibModal, $filter, $timeout, $http, HttpService, EnumType, Alert, toastr) {
        ...
        function getDefaultData() {
            ...
            if ($scope.defaultTypes == null || $scope.defaultTypes == undefined) {
                $scope.defaultTypes = [];
            } else {
                $scope.defaultTypes.length = 0;
            }
            ...
            HttpService.linkHttp(opts).then(function (response) {
                ...
                $scope.searchObj.tagTypeId = {label: "请选择...", value: ""};
            });
        ...
        $scope.detShow = function () {
            ...
            if (tagType == "tag") {
                ...
                $scope.searchObj.tagTypeId = selected;
                $scope.searchObj.tagName = "";
        ...
        var init = function () {
            ...
            $scope.tagMgrOpts={
                ...
                success:function(response){
                    ...
                    $scope.searchObj.parentTagId = {label: "请选择...", value: ""};
                    if (i === 0) {

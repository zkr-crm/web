(function () {
    ...
    angular.module('BlurAdmin.pages.interactmarket.tagMgr').controller(
    ...
    function tagMgrCtrl($scope, $uibModal, $filter, $timeout, $http, HttpService, EnumType, Alert, toastr) {
        ...
        function getDefaultData() {
            ...
            $scope.tagTypeT.splice(0, $scope.tagTypeT.length);
            debugger;
            ...
            HttpService.linkHttp(opts).then(function (response) {
                ...
                $scope.searchObj.tagTypeId1 = {label: "标签类别", value: ""};
            });
        ...
        $scope.detShow = function () {
            ...
            if (tagType == "tag") {
                ...
                $scope.searchObj.parentTagId1 = selected;
                $scope.searchObj.tagName = "";
                $scope.searchObj.tagTypeId1 = "";
...
//					toastr.success('提交完成!');
        ...
        $scope.addTag = function () {
            $scope.saveTag = {"tagTypeId": $scope.searchObj.tagTypeId1.value};
            $scope.isUpd = "false";
...
//						console.log(response);
        ...
        $scope.search =function(page){
            if ($scope.searchObj.tagTypeId1) {
                $scope.v = $scope.searchObj.tagTypeId1?$scope.searchObj.tagTypeId1.value:'';
                // $scope.searchObj.tagTypeId = "";
                $scope.searchObj.tagTypeId = $scope.v;
            }
            if ($scope.searchObj.parentTagId1) {
                $scope.v2 = $scope.searchObj.parentTagId1?$scope.searchObj.parentTagId1.value:'';
        ...
        var init = function () {
            ...
            $scope.tagMgrOpts={
                ...
                success:function(response){
                    ...
                    // $scope.searchObj.parentTagId1 = {label: "父级标签", value: ""};
                    if (i === 0) {
                        $scope.basicConfig.version++;
                        i++
                    }

(function () {
    ...
    angular.module('BlurAdmin.pages.busiopp')
        .controller('failureBusiOppCtrl', failureBusiOppCtrl);

    /** @ngInject */
    function failureBusiOppCtrl($scope, HttpService, EnumType, $uibModalInstance, $filter, Alert, $uibModal, busiOppNo,oldStage,newStage) {
		$scope.stageInfo = {};

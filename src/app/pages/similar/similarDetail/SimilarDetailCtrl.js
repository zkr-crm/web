(function() {
	...
	angular.module('BlurAdmin.pages.similar').controller('SimilarDetailCtrl',
			SimilarDetailCtrl);
	/** @ngInject */
	function SimilarDetailCtrl($scope, $stateParams, $state, $uibModal,
					...
					.then(
							function(response) {
								...
								angular.forEach($scope.rowCollection, function(
									...
									i.birthDate = i.birthDate?i.birthDate.substring(0, 10):'';
								});

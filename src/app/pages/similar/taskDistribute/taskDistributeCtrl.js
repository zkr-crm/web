    ...
    function taskDistributeCtrl($scope, $filter, $compile, $uibModal,
        ...
        var init = function () {
            ...
            $scope.searchObj.taskState = EnumType.SimTaskState.unDistribute.value+','
                +EnumType.SimTaskState.pending.value+','
                +EnumType.SimTaskState.merge_apply.value+','
                +EnumType.SimTaskState.merge_approv.value+','
                +EnumType.SimTaskState.merge_send_back.value+','
                +EnumType.SimTaskState.close_apply.value+','
                +EnumType.SimTaskState.close_send_back.value;
            // 分页查询所有任务
            $scope.queryOptions = {};

(function () {
    ...
    angular.module('BlurAdmin.pages.profile')
        .controller('canBlacklistCtrl', canBlacklistCtrl);

    /** @ngInject */
    function canBlacklistCtrl($scope, $http, HttpService,$uibModalInstance, Alert) {
        ...
        $scope.blacklistDts.blacklistSts = "1"; //重点客户
        $scope.blacklistDts.blacklistType = ""; //黑名单类型
        $scope.blacklistDts.phoneNumber = $scope.phoneNumber; //电话号码
        ...
        $scope.saveValue = function() {
            ...
            var opts = {};
            opts.url = '/crm/ecif/cust/cancelBlacklist';
            opts.method = 'PUT';

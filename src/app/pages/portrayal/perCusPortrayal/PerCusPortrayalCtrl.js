...
//	            });
	      ...
	      // -------------任务信息结束--------------
           ...
           $scope.changeFlag = function (pageFlag) {
            ...
            // 打开保单详情弹窗
            $scope.policyDetail = function (policyNo,riskCode) {
               var modalInstance = $uibModal.open({
                    animation: true,

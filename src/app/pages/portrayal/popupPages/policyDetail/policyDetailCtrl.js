(function () {
    ...
    /** @ngInject */
    function policyDetailCtrl($scope, HttpService, EnumType,$uibModalInstance, $filter, $uibModal, Alert, $rootScope, policyNo, custNo, riskCode) {
    	$scope.endorseInfo = function (endorNo) {

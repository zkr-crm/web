(function () {
    ...
    angular.module('BlurAdmin.pages.cusService.custComplt')
        .controller('allotCompltCtrl', allotCompltCtrl);

    /** @ngInject */
    function allotCompltCtrl($scope, HttpService, EnumType, $uibModalInstance, $filter, Alert, $uibModal, checkedRow) {
        console.log("allotCompltCtrl checkedRow= " + checkedRow);

(function () {
    ...
    angular.module('BlurAdmin.pages.cusService.custConsult')
        .controller('deliverConsultCtrl', deliverConsultCtrl);

    /** @ngInject */
    function deliverConsultCtrl($scope, HttpService, EnumType, $uibModalInstance, $filter, Alert, $uibModal, custNo) {
        console.log("deliverConsultCtrl custNo= " + custNo);
        $scope.deliver = {};

(function () {
    ...
    angular.module('BlurAdmin.pages.cusService.custRetVisit')
        .controller('deliverRetVisitCtrl', deliverRetVisitCtrl);

    /** @ngInject */
    function deliverRetVisitCtrl($scope, HttpService, EnumType, $uibModalInstance, $filter, Alert, $uibModal, custNo) {
        console.log("deliverRetVisitCtrl custNo= " + custNo);
        $scope.deliver = {};

(function () {
    ...
    angular.module('BlurAdmin.pages.cusService.custRetVisit')
        .controller('allotRetVisitCtrl', allotRetVisitCtrl);

    /** @ngInject */
    function allotRetVisitCtrl($scope, HttpService, EnumType, $uibModalInstance, $filter, Alert, $uibModal, checkedRow) {
        console.log("allotRetVisitCtrl checkedRow= " + checkedRow);
    	// 分页默认
